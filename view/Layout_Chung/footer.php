 ...
 <footer class="footer-area mt-no-text">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-custom">
                        <div class="single-footer-widget m-0">
                            <div class="footer-logo">
                                <a href="index.php">
                                    <img src="view/assets/images/logo/logo-footer.png" alt="Hình ảnh logo">
                                </a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-custom">
                                <div class="modal-product-img">
                                    <a class="w-100" href="#">
                                        <img class="w-100" src="view/assets/images/product/large-size/1.jpg" alt="Sản phẩm">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-6 col-custom">
    ...
    <!-- nice select JS -->
    <script src="view/assets/js/plugins/nice-select.min.js"></script>
    <!-- Ajaxchimpt js -->
    <script src="view/assets/js/plugins/jquery.ajaxchimp.min.js"></script>
    <!-- Jquery Ui js -->
